      ...
      <section className={`${darkMode ? 'dark bg-gray-800' : 'light bg-red-100'} lg:w-[90%] w-full h-fit m-auto bg-cover bg-center rounded-xl flex justify-center flex-col items-center lg:px-20 px-6 py-20 gap-20`}>
        <div id="top" className='w-full grid lg:grid-cols-3 grid-cols-1 justify-center items-center gap-8'>
          <div>
            ...
            <h1 data-aos="zoom-in" className={`${darkMode ? 'dark text-white' : 'light text-black'} text-[40px] font-semibold leading-10 mt-4 `}>
          ...
          <div className="grid lg:grid-cols-3 col-span-2 grid-cols-1 justify-center items-center gap-6">
            <div data-aos="zoom-in" data-aos-delay="400" style={{ backgroundImage: `url(${area1})` }} className="h-[400px] bg-cover bg-center rounded-xl flex gap-8"></div>
            <div data-aos="zoom-in" data-aos-delay="400" style={{ backgroundImage: `url(${area2})` }} className="h-[400px] bg-cover bg-center rounded-xl flex gap-8"></div>
            <div data-aos="zoom-in" data-aos-delay="400" style={{ backgroundImage: `url(${area3})` }} className="h-[400px] bg-cover bg-center rounded-xl flex gap-8"></div>
          </div>
        </div>
        <div id="bottom" className="w-full grid lg:grid-cols-3 grid-cols-1 lg:justify-center justify-start items-start gap-6">
          <div data-aos="slide-up" data-aos-delay="200" className="flex justify-center lg:items-center gap-8 w-full">
            <h1 className={`${darkMode ? 'dark text-white' : 'light text-black'} font-semibold text-7xl`}>
              5K 
            </h1>
            <h1 className={`${darkMode ? 'dark text-white' : 'light text-black'}`}>
              ACTIVE
              <br />
              LISTINGS
            </h1>
